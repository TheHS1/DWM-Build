...
static const char col_border[]	    = "#f55d42";
static const char col_cyan[]        = "#005577";
static const char col_selectedTagfg[] = "#2254B6";
static const char col_selectedTagbg[] = "#393939";
...
static const char *colors[][3]      = {
	...
	[SchemeTagsSel]  = { "#FFFFFF", col_selectedTagbg,  "#000000"  }, // Tagbar left selected {text,background,not used but cannot be empty}
...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", "#1d1f21", "-nf", "#d8dee9", "-sb", "#444", "-sf", "#268bd2", "-hp", "chromium", NULL };
...
static Key keys[] = {
	...
	TAGKEYS(                        XK_8,                      7)
	TAGKEYS(                        XK_9,                      8)
	{ MODKEY|ShiftMask,             XK_q,      spawn,          SHCMD("~/Scripts/stop") },
